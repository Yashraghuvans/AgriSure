    ...
    >
      ...
      <div className="z-20 p-4 md:p-8 max-w-4xl mx-auto">
        <h1 className="text-4xl md:text-6xl font-extrabold leading-tight mb-4 text-white">
          AgriSure: Building Farmer Trust with Smart Insurance
        </h1>
        ...
        <p className="text-base md:text-lg mb-10 max-w-2xl mx-auto text-gray-300">
          AgriSure's mission is to empower farmers with reliable, data-driven crop insurance solutions, ensuring their livelihoods are protected against the unpredictable impacts of climate change.
        </p>
